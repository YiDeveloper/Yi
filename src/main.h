...
static const int64_t DARKSEND_COLLATERAL = (15000*COIN); //15000
...
static const int64_t MAX_MONEY = 75000000 * COIN; //50M
...
inline int64_t MasternodeCollateral(int nHeight) { return 15000; } // 15K YIC required as collateral
