...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "Paradise Papers: Tax haven secrets of ultra-rich exposed 6/11/2017";
      ...
      // printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        vSeeds.push_back(CDNSSeedData("n0", "31.131.27.203"));
        vSeeds.push_back(CDNSSeedData("n1", "195.201.20.101"));
